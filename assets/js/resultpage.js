//Note: Saved local storage from user selected options on previous pages
...
const apiMovieDatabase = 'https://moviedatabase8.p.rapidapi.com/FindByImbdId/tt1375666';//retrieves movie poster
const apiMovieDatabaseResults = 'https://moviedatabase8.p.rapidapi.com/Filter?Limit=30&MinRating=5.1&MaxRating=9.9&MinYear=1980&MaxYear=2023&MinRevenue=1000000&MaxRevenue=300000000&Genre=Action%20Comedy%20History%20Horror&MinRuntime=60&MaxRuntime=180&OriginalLanguage=en&SpokenLanguage=English';//run time of movies
